# Musicxd - A Music Player WebApp where we can hear our favourite songs and create their playlists, add them to favourites. It has features like searching, Login (Authentication using JWT). It has backend part in Express.js and Node.js . Libraries Used - Joi, Joi-password-complexity , jsonwebtoken and Mongoose etc.
